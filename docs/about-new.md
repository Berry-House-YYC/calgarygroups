...
**Chapter** - Local branch of a larger organization with similar structures in other cities; typically more structured than clubs or grassroots groups.

**Cooperative** - Collective run by multiple organizations working together as an umbrella or coalition.

**Grassroots** - Activist or advocacy-focused groups with specific objectives; may have more limited scope in activities or engagement compared to nonprofits.

**Club** - Primarily social or interest-based groups where community connection is the main focus rather than advocacy.

**Small Business** - For-profit businesses that serve community needs or host community activities.
...
* Environment - Climate action, sustainability, green space, animal rights, conservation, and environmental advocacy
...
* Sports \& Rec - Sports, games, recreation, and active living
* Tech - Technology, coding, digital skills, and tech community
* Urban Issues - City planning, transit, housing, public safety, and general political advocacy.
* Women+ - Women and femme-focused communities. 
* Youth - Programs for children or young people. 

*Note: age ranges for youth and seniors differ across organizations.*



**Identity-focused tag**
