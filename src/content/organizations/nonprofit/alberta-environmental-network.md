...
name: "Alberta Environmental Network (AEN)"
type: Nonprofit
interests: ["environment", "health-wellness"]
age_range: "all-ages"
...
<div class="org-contact-info">
  ...
  <ul class="list-none pl-0">
    <li>Website: <a href="https://aenweb.ca/" target="_blank">https://aenweb.ca/</a></li>
    <li>Email: <a href="mailto:admin@aenweb.ca">admin@aenweb.ca</a></li>
  </ul>
</div>

**Notes:**
Similar to a grassroots organization in its programming and activist/advocacy efforts.
